...
class Vendor(models.Model):
    ...
    def is_open(self):
        ...
        # loop for multiple hours within a day
        is_open = None
        for i in current_hours:
            if i.is_closed:
                is_open = False
    ...
    def save(self, *args, **kwargs):
        if self.pk is not None:
            ...
            if orig.is_approved != self.is_approved:
                # There's an Update
                mail_template = 'admin_approval_email'
                context = {
                    'user': self.user,
                ...
                if self.is_approved == True:
                    ...
                    # send notif
                    mail_subject = "Sorry! Your restaurant is not eligible for publishing your food menu or our marketplace"
                    send_notification(mail_subject, mail_template, context)
